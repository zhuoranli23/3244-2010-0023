Disclaimer: this is taken from https://github.com/mseitzer/pytorch-fid. Licence is included in this folder as well. 

Files should be saved to separate directories and images saved in .jpg or .png extensions.

The following README is adapted from the original:
