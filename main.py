...
def get_args():
    ...
    parser.add_argument('--dataset_dir', type=str, default='./datasets/animesketch2color')
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints/animesketch2color')
